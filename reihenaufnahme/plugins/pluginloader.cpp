...
void PluginLoader::loadPlugins() {
    ...
    QDir pluginsDir(Reihenaufnahme::applicationDirPath());
    ...
    foreach (QString path, QCoreApplication::libraryPaths())
    {
        ...
        loadInputPlugins(path + Reihenaufnahme::applicationName().toLower());
        loadEditPlugins(path);
        loadEditPlugins(path + Reihenaufnahme::applicationName().toLower());
        loadOutputPlugins(path);
        loadOutputPlugins(path + Reihenaufnahme::applicationName().toLower());
    }
#if defined(Q_OS_WIN)
